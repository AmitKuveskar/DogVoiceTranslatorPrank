...
class FakeVideoCallActivity : AppCompatActivity(), SurfaceHolder.Callback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val videoUri = "android.resource://" + packageName + "/" + R.raw.husky
    ...
    private val cameraStateCallback = object : CameraDevice.StateCallback() {
        ...
        override fun onError(camera: CameraDevice, error: Int) {
            cameraDevice?.close()
            this@FakeVideoCallActivity.cameraDevice = null
        }
    }
