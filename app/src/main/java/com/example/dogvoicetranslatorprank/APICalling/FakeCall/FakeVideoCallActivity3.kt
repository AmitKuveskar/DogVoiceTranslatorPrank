...
class FakeVideoCallActivity3 : AppCompatActivity(), SurfaceHolder.Callback  {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_fake_video_call3)
        ...
        val videoUri = "android.resource://" + packageName + "/" + R.raw.labrador
    ...
    private val cameraStateCallback = object : CameraDevice.StateCallback() {
        ...
        override fun onError(camera: CameraDevice, error: Int) {
            cameraDevice?.close()
            this@FakeVideoCallActivity3.cameraDevice = null
        }
    }
