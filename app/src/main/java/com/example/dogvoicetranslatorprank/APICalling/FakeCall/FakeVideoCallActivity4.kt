...
class FakeVideoCallActivity4 : AppCompatActivity(), SurfaceHolder.Callback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_fake_video_call4)
        ...
        val videoUri = "android.resource://" + packageName + "/" + R.raw.shitzu
    ...
    private val cameraStateCallback = object : CameraDevice.StateCallback() {
        ...
        override fun onError(camera: CameraDevice, error: Int) {
            cameraDevice?.close()
            this@FakeVideoCallActivity4.cameraDevice = null
        }
    }
